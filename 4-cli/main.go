...
func setupCommands(ops *operations.Operations) commandMap {
	...
	commands[createCmd.Name()] = func() (string, error) {
	...
	commands[updateCmd.Name()] = func() (string, error) {
	...
	commands[deleteCmd.Name()] = func() (string, error) {
	...
	commands[getCmd.Name()] = func() (string, error) {
	...
	commands[listCmd.Name()] = func() (string, error) {
		err := getCmd.Parse(os.Args[2:])
		if err != nil {
			return "", err
		}
